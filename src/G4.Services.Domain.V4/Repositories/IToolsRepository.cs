...
namespace G4.Services.Domain.V4.Repositories
{
    ...
    public interface IToolsRepository
    {
        ...
        IDictionary<string, McpToolModel> FindExamples(string prompt);
        ...
        IDictionary<string, McpToolModel> FindExamples(string prompt, int maxResults);
        ...
        IEnumerable<(PluginExampleModel Example, int Score)> FindExamples(string toolName, string @namespace, string intent, int maxResults);
        ...
        IDictionary<string, McpToolModel> FindExamples(JsonElement parameters);
